...
SELECT *
FROM bl_cl.etl_log
WHERE procedure_name = 'load_ce_customers'
...
SELECT *
FROM bl_cl.etl_log
WHERE procedure_name = 'load_ce_products_scd'
ORDER BY log_datetime DESC;

SELECT * FROM bl_3nf.ce_customers LIMIT 20;
...
WHERE schema_name = 'bl_cl';

SELECT *
FROM bl_3nf.ce_products_scd
WHERE product_src_id = 'P00005';
...
FROM bl_3nf.ce_products_scd
WHERE product_src_id = 'P00005'
ORDER BY source_system, start_dt;